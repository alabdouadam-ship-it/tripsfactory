...
export const metadata = {
  title: "TripsFactory Admin",
  description: "TripsFactory Admin Dashboard",
};

const themeScript = `
(function() {
  try {
    var t = localStorage.getItem('tripsfactory_admin_theme');
    ...
    var s = localStorage.getItem('tripsfactory_admin_font_size');
