...
/// Budget default_page_size must match code (trip_service searchTrips limit=20).
void main() {
  ...
  test('Stage 3 default page size is 20 for trips', () {
    final budgets = loadPerfBudgets();
    final defaultPageSize = getInt(budgets['flutter'] as Map<String, dynamic>, 'default_page_size', 20);
    expect(defaultPageSize, 20, reason: 'searchTrips uses limit=20');
  });
