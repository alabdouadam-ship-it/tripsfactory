...
mixin _$Profile {
 ...
 String get id;@JsonKey(name: 'full_name') String get fullName;@JsonKey(name: 'phone_number') String? get phoneNumber; String? get bio;@JsonKey(name: 'is_available') bool get isAvailable;@JsonKey(name: 'traveler_status') String get travelerStatus;@JsonKey(name: 'traveler_type') String get travelerType;@JsonKey(name: 'identity_type') String get identityType;@JsonKey(name: 'identity_doc_url') String? get identityDocUrl;@JsonKey(name: 'traveler_license_url') String? get driverLicenseUrl;@JsonKey(name: 'rental_contract_url') String? get rentalContractUrl;@JsonKey(name: 'identity_doc_url_pending') String? get identityDocUrlPending;@JsonKey(name: 'traveler_license_url_pending') String? get travelerLicenseUrlPending;@JsonKey(name: 'rental_contract_url_pending') String? get rentalContractUrlPending;@JsonKey(name: 'created_at') DateTime? get createdAt;@JsonKey(name: 'onesignal_player_id') String? get oneSignalPlayerId;@JsonKey(name: 'avatar_url') String? get avatarUrl;@JsonKey(name: 'is_suspended') bool get isSuspended;@JsonKey(name: 'is_admin') bool get isAdmin;@JsonKey(name: 'subscription_expires_at') DateTime? get subscriptionExpiresAt;@JsonKey(name: 'license_expires_at') DateTime? get licenseExpiresAt;@JsonKey(name: 'traveler_rating_avg', fromJson: _ratingFromJson) num? get travelerRatingAvg;@JsonKey(name: 'traveler_rating_count') int? get travelerRatingCount;@JsonKey(name: 'client_rating_avg', fromJson: _ratingFromJson) num? get clientRatingAvg;@JsonKey(name: 'client_rating_count') int? get clientRatingCount;@JsonKey(name: 'is_driver') bool get isDriver;@JsonKey(name: 'driver_validity_date') DateTime? get driverValidityDate;@JsonKey(name: 'avatar_updated_at') DateTime? get avatarUpdatedAt;@JsonKey(name: 'is_blocked') bool get isBlocked;@JsonKey(name: 'suspension_reason') String? get suspensionReason;@JsonKey(name: 'promoted_until') DateTime? get promotedUntil;@JsonKey(name: 'is_trusted') bool get isTrusted;@JsonKey(name: 'is_featured') bool get isFeatured;@JsonKey(name: 'trust_badge') String? get trustBadge; List<Vehicle> get vehicles;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,fullName,phoneNumber,bio,isAvailable,travelerStatus,travelerType,identityType,identityDocUrl,driverLicenseUrl,rentalContractUrl,identityDocUrlPending,travelerLicenseUrlPending,rentalContractUrlPending,createdAt,oneSignalPlayerId,avatarUrl,isSuspended,isAdmin,subscriptionExpiresAt,licenseExpiresAt,travelerRatingAvg,travelerRatingCount,clientRatingAvg,clientRatingCount,isDriver,driverValidityDate,avatarUpdatedAt,isBlocked,suspensionReason,promotedUntil,isTrusted,isFeatured,trustBadge,const DeepCollectionEquality().hash(vehicles)]);

@override
String toString() {
  return 'Profile(id: $id, fullName: $fullName, phoneNumber: $phoneNumber, bio: $bio, isAvailable: $isAvailable, travelerStatus: $travelerStatus, travelerType: $travelerType, identityType: $identityType, identityDocUrl: $identityDocUrl, driverLicenseUrl: $driverLicenseUrl, rentalContractUrl: $rentalContractUrl, identityDocUrlPending: $identityDocUrlPending, travelerLicenseUrlPending: $travelerLicenseUrlPending, rentalContractUrlPending: $rentalContractUrlPending, createdAt: $createdAt, oneSignalPlayerId: $oneSignalPlayerId, avatarUrl: $avatarUrl, isSuspended: $isSuspended, isAdmin: $isAdmin, subscriptionExpiresAt: $subscriptionExpiresAt, licenseExpiresAt: $licenseExpiresAt, travelerRatingAvg: $travelerRatingAvg, travelerRatingCount: $travelerRatingCount, clientRatingAvg: $clientRatingAvg, clientRatingCount: $clientRatingCount, isDriver: $isDriver, driverValidityDate: $driverValidityDate, avatarUpdatedAt: $avatarUpdatedAt, isBlocked: $isBlocked, suspensionReason: $suspensionReason, promotedUntil: $promotedUntil, isTrusted: $isTrusted, isFeatured: $isFeatured, trustBadge: $trustBadge, vehicles: $vehicles)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'full_name') String fullName,@JsonKey(name: 'phone_number') String? phoneNumber, String? bio,@JsonKey(name: 'is_available') bool isAvailable,@JsonKey(name: 'traveler_status') String travelerStatus,@JsonKey(name: 'traveler_type') String travelerType,@JsonKey(name: 'identity_type') String identityType,@JsonKey(name: 'identity_doc_url') String? identityDocUrl,@JsonKey(name: 'traveler_license_url') String? driverLicenseUrl,@JsonKey(name: 'rental_contract_url') String? rentalContractUrl,@JsonKey(name: 'identity_doc_url_pending') String? identityDocUrlPending,@JsonKey(name: 'traveler_license_url_pending') String? travelerLicenseUrlPending,@JsonKey(name: 'rental_contract_url_pending') String? rentalContractUrlPending,@JsonKey(name: 'created_at') DateTime? createdAt,@JsonKey(name: 'onesignal_player_id') String? oneSignalPlayerId,@JsonKey(name: 'avatar_url') String? avatarUrl,@JsonKey(name: 'is_suspended') bool isSuspended,@JsonKey(name: 'is_admin') bool isAdmin,@JsonKey(name: 'subscription_expires_at') DateTime? subscriptionExpiresAt,@JsonKey(name: 'license_expires_at') DateTime? licenseExpiresAt,@JsonKey(name: 'traveler_rating_avg', fromJson: _ratingFromJson) num? travelerRatingAvg,@JsonKey(name: 'traveler_rating_count') int? travelerRatingCount,@JsonKey(name: 'client_rating_avg', fromJson: _ratingFromJson) num? clientRatingAvg,@JsonKey(name: 'client_rating_count') int? clientRatingCount,@JsonKey(name: 'is_driver') bool isDriver,@JsonKey(name: 'driver_validity_date') DateTime? driverValidityDate,@JsonKey(name: 'avatar_updated_at') DateTime? avatarUpdatedAt,@JsonKey(name: 'is_blocked') bool isBlocked,@JsonKey(name: 'suspension_reason') String? suspensionReason,@JsonKey(name: 'promoted_until') DateTime? promotedUntil,@JsonKey(name: 'is_trusted') bool isTrusted,@JsonKey(name: 'is_featured') bool isFeatured,@JsonKey(name: 'trust_badge') String? trustBadge, List<Vehicle> vehicles
});
...
/// Create a copy of Profile
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? fullName = null,Object? phoneNumber = freezed,Object? bio = freezed,Object? isAvailable = null,Object? travelerStatus = null,Object? travelerType = null,Object? identityType = null,Object? identityDocUrl = freezed,Object? driverLicenseUrl = freezed,Object? rentalContractUrl = freezed,Object? identityDocUrlPending = freezed,Object? travelerLicenseUrlPending = freezed,Object? rentalContractUrlPending = freezed,Object? createdAt = freezed,Object? oneSignalPlayerId = freezed,Object? avatarUrl = freezed,Object? isSuspended = null,Object? isAdmin = null,Object? subscriptionExpiresAt = freezed,Object? licenseExpiresAt = freezed,Object? travelerRatingAvg = freezed,Object? travelerRatingCount = freezed,Object? clientRatingAvg = freezed,Object? clientRatingCount = freezed,Object? isDriver = null,Object? driverValidityDate = freezed,Object? avatarUpdatedAt = freezed,Object? isBlocked = null,Object? suspensionReason = freezed,Object? promotedUntil = freezed,Object? isTrusted = null,Object? isFeatured = null,Object? trustBadge = freezed,Object? vehicles = null,}) {
...
as bool,driverValidityDate: freezed == driverValidityDate ? _self.driverValidityDate : driverValidityDate // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'full_name')  String fullName, @JsonKey(name: 'phone_number')  String? phoneNumber,  String? bio, @JsonKey(name: 'is_available')  bool isAvailable, @JsonKey(name: 'traveler_status')  String travelerStatus, @JsonKey(name: 'traveler_type')  String travelerType, @JsonKey(name: 'identity_type')  String identityType, @JsonKey(name: 'identity_doc_url')  String? identityDocUrl, @JsonKey(name: 'traveler_license_url')  String? driverLicenseUrl, @JsonKey(name: 'rental_contract_url')  String? rentalContractUrl, @JsonKey(name: 'identity_doc_url_pending')  String? identityDocUrlPending, @JsonKey(name: 'traveler_license_url_pending')  String? travelerLicenseUrlPending, @JsonKey(name: 'rental_contract_url_pending')  String? rentalContractUrlPending, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'onesignal_player_id')  String? oneSignalPlayerId, @JsonKey(name: 'avatar_url')  String? avatarUrl, @JsonKey(name: 'is_suspended')  bool isSuspended, @JsonKey(name: 'is_admin')  bool isAdmin, @JsonKey(name: 'subscription_expires_at')  DateTime? subscriptionExpiresAt, @JsonKey(name: 'license_expires_at')  DateTime? licenseExpiresAt, @JsonKey(name: 'traveler_rating_avg', fromJson: _ratingFromJson)  num? travelerRatingAvg, @JsonKey(name: 'traveler_rating_count')  int? travelerRatingCount, @JsonKey(name: 'client_rating_avg', fromJson: _ratingFromJson)  num? clientRatingAvg, @JsonKey(name: 'client_rating_count')  int? clientRatingCount, @JsonKey(name: 'is_driver')  bool isDriver, @JsonKey(name: 'driver_validity_date')  DateTime? driverValidityDate, @JsonKey(name: 'avatar_updated_at')  DateTime? avatarUpdatedAt, @JsonKey(name: 'is_blocked')  bool isBlocked, @JsonKey(name: 'suspension_reason')  String? suspensionReason, @JsonKey(name: 'promoted_until')  DateTime? promotedUntil, @JsonKey(name: 'is_trusted')  bool isTrusted, @JsonKey(name: 'is_featured')  bool isFeatured, @JsonKey(name: 'trust_badge')  String? trustBadge,  List<Vehicle> vehicles)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Profile() when $default != null:
return $default(_that.id,_that.fullName,_that.phoneNumber,_that.bio,_that.isAvailable,_that.travelerStatus,_that.travelerType,_that.identityType,_that.identityDocUrl,_that.driverLicenseUrl,_that.rentalContractUrl,_that.identityDocUrlPending,_that.travelerLicenseUrlPending,_that.rentalContractUrlPending,_that.createdAt,_that.oneSignalPlayerId,_that.avatarUrl,_that.isSuspended,_that.isAdmin,_that.subscriptionExpiresAt,_that.licenseExpiresAt,_that.travelerRatingAvg,_that.travelerRatingCount,_that.clientRatingAvg,_that.clientRatingCount,_that.isDriver,_that.driverValidityDate,_that.avatarUpdatedAt,_that.isBlocked,_that.suspensionReason,_that.promotedUntil,_that.isTrusted,_that.isFeatured,_that.trustBadge,_that.vehicles);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'full_name')  String fullName, @JsonKey(name: 'phone_number')  String? phoneNumber,  String? bio, @JsonKey(name: 'is_available')  bool isAvailable, @JsonKey(name: 'traveler_status')  String travelerStatus, @JsonKey(name: 'traveler_type')  String travelerType, @JsonKey(name: 'identity_type')  String identityType, @JsonKey(name: 'identity_doc_url')  String? identityDocUrl, @JsonKey(name: 'traveler_license_url')  String? driverLicenseUrl, @JsonKey(name: 'rental_contract_url')  String? rentalContractUrl, @JsonKey(name: 'identity_doc_url_pending')  String? identityDocUrlPending, @JsonKey(name: 'traveler_license_url_pending')  String? travelerLicenseUrlPending, @JsonKey(name: 'rental_contract_url_pending')  String? rentalContractUrlPending, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'onesignal_player_id')  String? oneSignalPlayerId, @JsonKey(name: 'avatar_url')  String? avatarUrl, @JsonKey(name: 'is_suspended')  bool isSuspended, @JsonKey(name: 'is_admin')  bool isAdmin, @JsonKey(name: 'subscription_expires_at')  DateTime? subscriptionExpiresAt, @JsonKey(name: 'license_expires_at')  DateTime? licenseExpiresAt, @JsonKey(name: 'traveler_rating_avg', fromJson: _ratingFromJson)  num? travelerRatingAvg, @JsonKey(name: 'traveler_rating_count')  int? travelerRatingCount, @JsonKey(name: 'client_rating_avg', fromJson: _ratingFromJson)  num? clientRatingAvg, @JsonKey(name: 'client_rating_count')  int? clientRatingCount, @JsonKey(name: 'is_driver')  bool isDriver, @JsonKey(name: 'driver_validity_date')  DateTime? driverValidityDate, @JsonKey(name: 'avatar_updated_at')  DateTime? avatarUpdatedAt, @JsonKey(name: 'is_blocked')  bool isBlocked, @JsonKey(name: 'suspension_reason')  String? suspensionReason, @JsonKey(name: 'promoted_until')  DateTime? promotedUntil, @JsonKey(name: 'is_trusted')  bool isTrusted, @JsonKey(name: 'is_featured')  bool isFeatured, @JsonKey(name: 'trust_badge')  String? trustBadge,  List<Vehicle> vehicles)  $default,) {final _that = this;
switch (_that) {
case _Profile():
return $default(_that.id,_that.fullName,_that.phoneNumber,_that.bio,_that.isAvailable,_that.travelerStatus,_that.travelerType,_that.identityType,_that.identityDocUrl,_that.driverLicenseUrl,_that.rentalContractUrl,_that.identityDocUrlPending,_that.travelerLicenseUrlPending,_that.rentalContractUrlPending,_that.createdAt,_that.oneSignalPlayerId,_that.avatarUrl,_that.isSuspended,_that.isAdmin,_that.subscriptionExpiresAt,_that.licenseExpiresAt,_that.travelerRatingAvg,_that.travelerRatingCount,_that.clientRatingAvg,_that.clientRatingCount,_that.isDriver,_that.driverValidityDate,_that.avatarUpdatedAt,_that.isBlocked,_that.suspensionReason,_that.promotedUntil,_that.isTrusted,_that.isFeatured,_that.trustBadge,_that.vehicles);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'full_name')  String fullName, @JsonKey(name: 'phone_number')  String? phoneNumber,  String? bio, @JsonKey(name: 'is_available')  bool isAvailable, @JsonKey(name: 'traveler_status')  String travelerStatus, @JsonKey(name: 'traveler_type')  String travelerType, @JsonKey(name: 'identity_type')  String identityType, @JsonKey(name: 'identity_doc_url')  String? identityDocUrl, @JsonKey(name: 'traveler_license_url')  String? driverLicenseUrl, @JsonKey(name: 'rental_contract_url')  String? rentalContractUrl, @JsonKey(name: 'identity_doc_url_pending')  String? identityDocUrlPending, @JsonKey(name: 'traveler_license_url_pending')  String? travelerLicenseUrlPending, @JsonKey(name: 'rental_contract_url_pending')  String? rentalContractUrlPending, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'onesignal_player_id')  String? oneSignalPlayerId, @JsonKey(name: 'avatar_url')  String? avatarUrl, @JsonKey(name: 'is_suspended')  bool isSuspended, @JsonKey(name: 'is_admin')  bool isAdmin, @JsonKey(name: 'subscription_expires_at')  DateTime? subscriptionExpiresAt, @JsonKey(name: 'license_expires_at')  DateTime? licenseExpiresAt, @JsonKey(name: 'traveler_rating_avg', fromJson: _ratingFromJson)  num? travelerRatingAvg, @JsonKey(name: 'traveler_rating_count')  int? travelerRatingCount, @JsonKey(name: 'client_rating_avg', fromJson: _ratingFromJson)  num? clientRatingAvg, @JsonKey(name: 'client_rating_count')  int? clientRatingCount, @JsonKey(name: 'is_driver')  bool isDriver, @JsonKey(name: 'driver_validity_date')  DateTime? driverValidityDate, @JsonKey(name: 'avatar_updated_at')  DateTime? avatarUpdatedAt, @JsonKey(name: 'is_blocked')  bool isBlocked, @JsonKey(name: 'suspension_reason')  String? suspensionReason, @JsonKey(name: 'promoted_until')  DateTime? promotedUntil, @JsonKey(name: 'is_trusted')  bool isTrusted, @JsonKey(name: 'is_featured')  bool isFeatured, @JsonKey(name: 'trust_badge')  String? trustBadge,  List<Vehicle> vehicles)?  $default,) {final _that = this;
switch (_that) {
case _Profile() when $default != null:
return $default(_that.id,_that.fullName,_that.phoneNumber,_that.bio,_that.isAvailable,_that.travelerStatus,_that.travelerType,_that.identityType,_that.identityDocUrl,_that.driverLicenseUrl,_that.rentalContractUrl,_that.identityDocUrlPending,_that.travelerLicenseUrlPending,_that.rentalContractUrlPending,_that.createdAt,_that.oneSignalPlayerId,_that.avatarUrl,_that.isSuspended,_that.isAdmin,_that.subscriptionExpiresAt,_that.licenseExpiresAt,_that.travelerRatingAvg,_that.travelerRatingCount,_that.clientRatingAvg,_that.clientRatingCount,_that.isDriver,_that.driverValidityDate,_that.avatarUpdatedAt,_that.isBlocked,_that.suspensionReason,_that.promotedUntil,_that.isTrusted,_that.isFeatured,_that.trustBadge,_that.vehicles);case _:
  return null;
...
class _Profile extends Profile {
  const _Profile({required this.id, @JsonKey(name: 'full_name') required this.fullName, @JsonKey(name: 'phone_number') this.phoneNumber, this.bio, @JsonKey(name: 'is_available') this.isAvailable = false, @JsonKey(name: 'traveler_status') this.travelerStatus = DomainConfig.statusNone, @JsonKey(name: 'traveler_type') this.travelerType = DomainConfig.travelerNoVehicle, @JsonKey(name: 'identity_type') this.identityType = DomainConfig.identityIdCard, @JsonKey(name: 'identity_doc_url') this.identityDocUrl, @JsonKey(name: 'traveler_license_url') this.driverLicenseUrl, @JsonKey(name: 'rental_contract_url') this.rentalContractUrl, @JsonKey(name: 'identity_doc_url_pending') this.identityDocUrlPending, @JsonKey(name: 'traveler_license_url_pending') this.travelerLicenseUrlPending, @JsonKey(name: 'rental_contract_url_pending') this.rentalContractUrlPending, @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'onesignal_player_id') this.oneSignalPlayerId, @JsonKey(name: 'avatar_url') this.avatarUrl, @JsonKey(name: 'is_suspended') this.isSuspended = false, @JsonKey(name: 'is_admin') this.isAdmin = false, @JsonKey(name: 'subscription_expires_at') this.subscriptionExpiresAt, @JsonKey(name: 'license_expires_at') this.licenseExpiresAt, @JsonKey(name: 'traveler_rating_avg', fromJson: _ratingFromJson) this.travelerRatingAvg, @JsonKey(name: 'traveler_rating_count') this.travelerRatingCount, @JsonKey(name: 'client_rating_avg', fromJson: _ratingFromJson) this.clientRatingAvg, @JsonKey(name: 'client_rating_count') this.clientRatingCount, @JsonKey(name: 'is_driver') this.isDriver = false, @JsonKey(name: 'driver_validity_date') this.driverValidityDate, @JsonKey(name: 'avatar_updated_at') this.avatarUpdatedAt, @JsonKey(name: 'is_blocked') this.isBlocked = false, @JsonKey(name: 'suspension_reason') this.suspensionReason, @JsonKey(name: 'promoted_until') this.promotedUntil, @JsonKey(name: 'is_trusted') this.isTrusted = false, @JsonKey(name: 'is_featured') this.isFeatured = false, @JsonKey(name: 'trust_badge') this.trustBadge, final  List<Vehicle> vehicles = const []}): _vehicles = vehicles,super._();
...
/// Create a copy of Profile
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? fullName = null,Object? phoneNumber = freezed,Object? bio = freezed,Object? isAvailable = null,Object? travelerStatus = null,Object? travelerType = null,Object? identityType = null,Object? identityDocUrl = freezed,Object? driverLicenseUrl = freezed,Object? rentalContractUrl = freezed,Object? identityDocUrlPending = freezed,Object? travelerLicenseUrlPending = freezed,Object? rentalContractUrlPending = freezed,Object? createdAt = freezed,Object? oneSignalPlayerId = freezed,Object? avatarUrl = freezed,Object? isSuspended = null,Object? isAdmin = null,Object? subscriptionExpiresAt = freezed,Object? licenseExpiresAt = freezed,Object? travelerRatingAvg = freezed,Object? travelerRatingCount = freezed,Object? clientRatingAvg = freezed,Object? clientRatingCount = freezed,Object? isDriver = null,Object? driverValidityDate = freezed,Object? avatarUpdatedAt = freezed,Object? isBlocked = null,Object? suspensionReason = freezed,Object? promotedUntil = freezed,Object? isTrusted = null,Object? isFeatured = null,Object? trustBadge = freezed,Object? vehicles = null,}) {
